...
const Submenu = ({ data, index, open, active, props }) => {
    ...
    return (
        <>
            ...
            <div className="relative">
                            ...
                            <Link
                                className={`sidebarSubmenu ${
                                    ...
                                    props.location.pathname === data.subPath
                                        ? "text-slate-50 bg-slate-500 bg-opacity-20 font-bold"
                ...
                {/* Sous Menu lorsque l'open est à false */}
                {subMenu2 &&
                    data.submenu.map((data, index) => {
                        return (
                            <Link
