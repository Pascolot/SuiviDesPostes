...
export default function DeleteModalDef2({ toggle, refs, isShowingNow, t }) {
    ...
    return (
        <div>
            ...
            >
                <div className="w-4/5 max-w-md bg-white shadow-md bg-opacity-60 shadow-gray-700 border-2 border-sky-500 rounded-2xl">
                    ...
                    <div>
                        <p className="font-bold text-sm text-center p-2">
