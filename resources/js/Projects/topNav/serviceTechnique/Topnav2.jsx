...
import DropDown2 from "../../dropdown/seviceTechnique/DropDown2";
import { useTranslation } from "react-i18next";
import DropDown3 from "../../dropdown/seviceTechnique/DropDown3";
            ...
            <div className="dropDown h-full items-center flex mr-10">
                ...
                <div className="text-gray-700 mr-8 relative cm:hidden">
                    <FontAwesomeIcon
                        ...
                        icon={faEnvelope}
                    />
                    <span className="badge bg-blue-700">8</span>
                </div>
