...
import userImg from "../../src/anonyme.png";
import ModeEnable from "../../darkMode/ModeEnable";
import axios from "axios";
import Dropdown from "../../dropdown/Dropdown";
import DropDown2 from "../../dropdown/respTT/DropDown2";
import { useTranslation } from "react-i18next";
import DropDown3 from "../../dropdown/respTT/DropDown3";
...
const Topnav = () => {
    ...
    // Gestionnaire de l'événement pour le dropdown
    ...
    useEffect(() => {
        let isMounted = true;
        axios.get("notification3").then((response) => {
            if (isMounted) {
        ...
        <div className="topnav">
            ...
            <div className="dropDown h-full items-center flex mr-10">
                ...
                >
                    ...
                    >
                        <DropDown2 t={t} i18n={i18n} notif={notif.length} />
                    </div>
                </div>
                <div className="text-black mr-8 relative cm:hidden">
                    <FontAwesomeIcon
                        className="text-gray-700 cursor-pointer"
                        icon={faEnvelope}
                    />
                    <span className="badge bg-blue-700">6</span>
                </div>
                ...
                >
                    <div className="text-gray-700 font-semibold text-sm cursor-pointer">
                        {t("translate")}
                        <span className="ml-2">
